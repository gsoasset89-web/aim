      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
            <SheetContent
                ...
                data-mobile="true"
                className={cn("w-[--sidebar-width] p-0 text-sidebar-foreground [&>button]:hidden z-[60]", className)}
                style={
                {
        ...
        <div
          className={cn(
            ...
            variant === "floating" || variant === "inset"
              ...
              : "group-data-[state=collapsed]:border-r-0 group-data-[side=right]:border-l-0",
            className
          )}
          {...props}
        >
          <div
            data-sidebar="sidebar"
            className={cn("flex h-full w-full flex-col bg-sidebar group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow", className)}
          >
            {children}
          </div>
        </div>
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute top-1/2 -translate-y-1/2 z-20 flex items-center justify-center h-8 w-6 rounded-full bg-sidebar-accent/50 text-sidebar-accent-foreground/80 outline-none ring-sidebar-ring transition-all ease-linear focus-visible:ring-2 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground",
        "group-data-[side=left]:-right-3 group-data-[side=right]:-left-3",
        className
      )}
      {...props}
    >
        <ChevronRight className={cn("h-4 w-4 transition-transform", state === 'expanded' && 'rotate-180')} />
    </button>
  )
})
